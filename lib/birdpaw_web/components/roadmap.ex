  ...
  def render(assigns) do
    ...
    >
      <div class="max-w-6xl mx-auto relative px-4" phx-hook="ScrollReveal" id="timeline">
        ...
        <div class="timeline-item relative flex flex-col md:flex-row items-center mb-16 opacity-0">
          <div class="timeline-icon bg-blue-600 text-white rounded-full p-4 mb-4 md:mb-0 md:mr-6 shadow-lg flex items-center justify-center text-2xl font-bold">
            1
          </div>

          <div class="timeline-content bg-gray-800 p-8 rounded-lg shadow-lg text-center md:text-left w-full md:w-3/4 lg:w-2/3">
        ...
        <div class="timeline-item relative flex flex-col md:flex-row items-center mb-16 opacity-0">
          <div class="timeline-icon bg-green-600 text-white rounded-full p-4 mb-4 md:mb-0 md:mr-6 shadow-lg flex items-center justify-center text-2xl font-bold">
            2
          </div>
        ...
        <div class="timeline-item relative flex flex-col md:flex-row items-center mb-16 opacity-0">
          <div class="timeline-icon bg-purple-600 text-white rounded-full p-4 mb-4 md:mb-0 md:mr-6 shadow-lg flex items-center justify-center text-2xl font-bold">
            3
          </div>
          ...
          <div class="timeline-content bg-gray-800 p-8 rounded-lg shadow-lg text-center md:text-left w-full md:w-3/4 lg:w-2/3">
            ...
            <p class="text-lg text-purple-400 mb-4">Phase 3 (In Progress)</p>
        ...
        <div class="timeline-item relative flex flex-col md:flex-row items-center mb-16 opacity-0">
          <div class="timeline-icon bg-orange-600 text-white rounded-full p-4 mb-4 md:mb-0 md:mr-6 shadow-lg flex items-center justify-center text-2xl font-bold">
            4
          </div>
